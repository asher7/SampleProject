...
@Configuration
@ComponentScan(basePackages = { "com.feuji.SpringMvcHybernate.Dao" })
...
//	}
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.springMvcHybernate.entity" });
